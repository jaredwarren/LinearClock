...
// HTMLDisplay renders the clock face as HTML for the config server test page.
...
// NewHTMLDisplay returns a Displayer that renders to HTTP for web preview.
...
// Num holds hour and color for template.
type Num struct {
	Hour  string
	Color string
}
