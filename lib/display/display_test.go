...
func TestDisplayTime(t *testing.T) {
	...
	t.Run("Tick LEDs", func(t *testing.T) {
		...
		// m=37. ftick = (15*2 - 37 + 15) / 15 = 8 / 15
		// Fade is between Tick.PastColor (0xff0000) and Num.PresentColor (0x0000bb)
		// r = (7/15)*255 = 119
		// g = 0
		// b = (8/15)*187 = 99.7 -> 100
		...
		// LEDs 7-15 are future
		// alt: i=0-3(F), 4-7(T), 8-11(F), 12-15(T)
	...
	t.Run("Number LEDs", func(t *testing.T) {
		// Number LEDs are at indices 18-33. They are reversed.
		// Before reversal: htick=4. TicksPerHour=4.
		// 4 leds for past (hour 9), 4 for present (hour 10), 8 for future (hour 11, 12)
		// Indices 18-21: PastColor, 22-25: PresentColor, 26-33: FutureColor
		// After reversal of indices 18-33:
		// Indices 18-25: FutureColor, 26-29: PresentColor, 30-33: PastColor
		for i := 18; i <= 25; i++ {
